...
# Plot Graph
plot_graph <- function() {
	vpos <- c(68.56, 69.81, 38.81, 42.67, 48.6, 61.91, 94.32,96.15)
	vname <- c('SF Snoqual R', 'NF Snoqual R', 'Tolt R', 'Griffin Cr', 'Patterson Cr', 'Tokul Cr', 'Unnamed1', 'Unamed2')
	yval <- min(df$value)
	...
	p <- g + 
		...
		geom_vline(xintercept=c(68.56, 69.81, 38.81, 42.67, 48.6, 61.91), color="blue") + 
		geom_vline(xintercept=c(94.32,96.15), color="red") + 
		annotate("text", x=vpos, y=yval, label=vname, angle = 90, size=4, vjust=0, hjust=0, color='black') + 
